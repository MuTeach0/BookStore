...
public class BookController(IBookRepository bookRepo, IGenreRepository genreRepo,
    IFileService fileService) : Controller
{
    ...
    public async Task<IActionResult> AddBook(BookDTO bookToAdd)
    {
        ...
        try
        {
            if (bookToAdd.ImageFile is not null)
            {
                ...
                string imageName = await _fileService.SaveFile(bookToAdd.ImageFile,
                    allowedExtensions);
    ...
    public async Task<IActionResult> UpdateBook(int id)
    {
        ...
        if (book is null)
        {
            TempData["errorMessage"] = $"Book with id: {id} does not found";
    ...
    public async Task<IActionResult> UpdateBook(BookDTO bookToUpdate)
    {
        ...
        try
        {
            ...
            if (bookToUpdate.ImageFile is not null)
            {
                ...
                string[] allowedExtensions = [".jpeg", ".jpg", ".png"];
                string imageName = await _fileService.SaveFile(bookToUpdate.ImageFile,
                    allowedExtensions);
            ...
            // if image is update, then delete it form the folder too
